...
namespace Kutuphane
{
    public partial class GorevliOgrenciEkle : UserControl
    {
        public GorevliOgrenciEkle()
        {
            InitializeComponent();
        }
        private void GorevliOgrenciEkle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox5.Text = "Şifre Gir"; // textBox' a Kullanıcı Adı Gir yazmamızı sağlar
            ...
            if (t1 ==1 && t2==1 && t3==1 && t4==1 && t5== 1)
            {
                ...
                if (OgrenciBL.ogrenciOkulNoKOntrol(ogrenci) == true)  // Öğrencinin kayıtlı olma durumu kontrol edildi
                {
                    ...
                    OgrenciEklendi ogrenciEklendi = new OgrenciEklendi();
                    ogrenciEklendi.Show();
                    dataGridView1.DataSource = OgrenciBL.liste(); // Ekleme işleminden sonra listenin güncel halini ekrana yansıttık
                }
                else
                {
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            ...
            textBox5.PasswordChar = '*'; // textBox doldurulunca içindeki metnin *** olarak görünmesini sağlar
        }
        private void pictureBox3_MouseHover(object sender, EventArgs e)
        {
            textBox5.PasswordChar = '\0'; // textBox doldurulunca içindeki metnin görünmesini sağlar
        }
        ...
        {
            textBox3.Text = ""; // textBox3' a tıklanınca içinde yazılan değerler silinir
        }
        ...
        private void GorevliOgrenciEkle_Leave(object sender, EventArgs e)
        {
            label4.Visible = false;//label' ı gizlemek için Visible kullanılır
            label1.Visible = false;//label' ı gizlemek için Visible kullanılır
            label5.Visible = false;//label' ı gizlemek için Visible kullanılır
